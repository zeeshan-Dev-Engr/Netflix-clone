  ...
  return (
    <div className='hero-bg relative'>
			...
			<header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
				...
				<Link to={"/login"} className='text-white bg-red-600 py-1 font-bold px-2 rounded'>
					LogIn
				</Link>
			</header>
			...
			<div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
				...
				<form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleSubmet}>
					<input
						type='email'
            ...
            onChange={(e) => setEmail(e.target.value)}
					/>
					<button className='bg-red-600 text-xl lg:text-2xl cursor-pointer px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center'>
						Get Started
